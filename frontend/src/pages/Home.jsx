    ...
    <div className="flex h-screen bg-gray-900 text-gray-200 overflow-hidden">
      ...
      <div className="w-3/5 flex flex-col h-full bg-gradient-to-b from-gray-800 to-gray-900">
        ...
        <div className="p-4 border-t border-gray-700 bg-gray-800 flex space-x-4">
          ...
          <button
            onClick={startPodcast} // Replace with actual podcast start function
            className="w-1/2 py-3 px-4 rounded-lg font-medium flex items-center justify-center bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white transition duration-200 shadow-lg"
          >
            <svg
